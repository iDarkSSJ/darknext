...
interface CarouselOnSnapCustomProps
  extends React.HTMLAttributes<HTMLDivElement> {
  index: number
}

const CarouselOnSnap = React.forwardRef<
  HTMLDivElement,
  CarouselOnSnapCustomProps
>(({ className, index, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        `min-w-0 transition-opacity duration-500 delay-200 ${
          selectedSnap === index ? "opacity-100" : "opacity-0"
        }`,
        className
      )}
      {...props}
...
CarouselOnSnap.displayName = "CarouselOnSnap"
